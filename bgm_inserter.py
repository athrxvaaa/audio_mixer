...
class BGMInserter:
    ...
    def group_segments_by_topic(self, segments):
        # Prepare a prompt for GPT to group segments by 5 specific themes
        prompt = """
...
"""
    ...
    def process_audio(self, audio_path: str, output_path: Optional[str] = None) -> str:
        ...
        for i, (start, end, bgm) in enumerate(bgm_segments):
            # Apply uniform volume reduction (default 35dB)
            bgm = bgm - 35.0
            print(f"  Applied 35.0dB reduction")
